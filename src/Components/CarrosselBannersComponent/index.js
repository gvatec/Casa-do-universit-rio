    ...
    return (
        <section className="containerCarrossel">
            <div className="banneritem">
                ...
                <button id='arrow1' onClick={stepBannerLeft}><FiArrowLeft color="#2d2d2d" size={25}></FiArrowLeft></button>
                <button id='arrow2' onClick={stepBannerRight}><FiArrowRight color="#2d2d2d" size={25}></FiArrowRight></button>
            </div>
        </section>
    )
}
