  ...
  async function singup(e) {
    ...
    if (password !== repetpassword) {
      document
        ...
        .setAttribute("style", "color:red;transition: color 0.5s ease;font-Weight:600");
    ...
    await api
      ...
      .then(() => {
        document
          ...
          .setAttribute(
            "style",
            "color:green;transition: color background 0.5s ease;font-Weight:600;background:rgb(172, 255, 172);padding:5px;"
          );
    ...
    <div className="container-cadastro">
      <div className="container-form">
        <a href="/" className="btn-back">
          <BsArrowLeft color="#fff" size={30}></BsArrowLeft>
        </a>
